# ADLC and engineering delivery — ai
...
Stage 3 delivers the approved foundation through live issues and a review PR. Product implementation and PR merge remain outside this stage. Refresh existing GitHub issues before allocating future identifiers. Use linked implementation issues for materially different repository responsibilities, with explicit completion evidence on coordination issues.
